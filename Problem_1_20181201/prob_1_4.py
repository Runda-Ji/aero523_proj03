...
def main():
    ...
    plt.grid();
    plt.legend();
    plt.savefig('density_Roe_flux.pdf', dpi=150);
    plt.show();
    plt.close(f);
    return 0;
